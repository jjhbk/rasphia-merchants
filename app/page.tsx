...
export default function Home() {
  return <main>
    ...
    <section className="google-data-section"><div className="wrap google-data-grid"><div><p className="section-label">Google sign-in & your data</p><h2>Your workspace stays yours.</h2><p>Rasphia helps local businesses run lead, booking, follow-up, and payment workflows from one private workspace. Sign in with Google to create and secure your Rasphia account.</p></div><div className="google-data-card"><h3>What Rasphia accesses</h3><dl><div><dt>Google profile</dt><dd>Your name and verified email, used to create and secure your Rasphia account.</dd></div><div><dt>Google Calendar</dt><dd>Only when you connect it, to check booking availability and create or update Rasphia bookings.</dd></div><div><dt>Google Drive</dt><dd>Only when you select a folder, to answer approved business questions from your own documents.</dd></div></dl><p>Rasphia does not request Calendar or Drive access when you simply sign in. <Link href="/privacy">Read our Privacy Policy</Link>.</p></div></div></section>
    ...
    <footer><div className="wrap footer-inner"><span>© 2026 · Rasphia</span><span><Link href="/faq">FAQ</Link> · <Link href="/privacy">Privacy</Link> · <Link href="/terms">Terms</Link> · GROW · RETAIN · EARN</span></div></footer>
