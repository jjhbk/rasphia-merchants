...
export default function Home() {
  ...
  return <main className="home-v2">
    <nav className="home-nav"><div className="wrap nav-inner"><a className="wordmark" href="#top">rasph<em>ia</em></a><div className="nav-actions"><a className="nav-utility" href="#platform">Platform</a><a className="nav-utility" href="#industries">Industries</a><a className="nav-utility" href="#how">How it works</a><Link className="nav-utility" href="/privacy">Privacy</Link><Link className="nav-utility" href={dashboardUrl || "/login"}>{dashboardUrl ? "Dashboard" : "Sign in"}</Link><Link className="button button-dark" href="/diagnosis">Get free diagnosis</Link></div></div></nav>
