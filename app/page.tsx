...
export default function Home() { return <main>
  <nav><div className="wrap nav-inner"><a href="#top" className="wordmark">rasph<em>ia</em></a><div className="nav-actions"><Link className="nav-score-link" href="/ai-readiness">Free AI score</Link><a className="button button-dark" href="#start">Talk to us</a></div></div></nav>
  <header id="top" className="hero"><div className="wrap hero-grid"><div className="hero-copy"><p className="eyebrow">Rasphia · Native to Claude & ChatGPT</p><h1>Your customers aren&apos;t <span>searching</span>.<br />They&apos;re <em>asking</em>.</h1><p className="lede">Millions of people now ask AI for exactly what you offer — and get one confident recommendation back, not ten links. Rasphia makes your business that answer, with booking and payment completing inside the same chat.</p><div className="actions"><a className="button button-gold" href="#start">Get your business AI-ready</a><Link className="button button-outline" href="/ai-readiness">Check your AI score</Link><a className="button button-outline" href="#how">See how it works</a></div><p className="note">No ads to buy. No app to manage. One conversation to get started.</p></div><ChatDemo /></div></header>
